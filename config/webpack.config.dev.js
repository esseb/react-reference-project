...
module.exports = {
  // Build source maps to make the original source visibile when debugging in
  // browser devtools.
  ...
  entry: [
    // Use WebpackHotMiddleware to connect to the Express WebpackHotMiddleware
    // socket and get notified about changes.
